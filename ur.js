import { SolSignRequest, SolSignature, CryptoMultiAccounts } from "@keystonehq/bc-ur-registry-sol";
...
// const syncUR = 'UR:CRYPTO-MULTI-ACCOUNTS/OTADCYJOKBWEJZAOLYTAADDLOXAOWKAXHDCLAECYMUZMZODSTOIEHTUEPLHDWTWKBBSRCXRFWPDYTOBGOLJETDIAPTCKSOQDMDMYWKAMTAADDYOTADLNCSDWYKCFADYKYKAEYKAOCYJOKBWEJZAXAXASISGRIHKKJKJYJLJTIHAXISGRIHKKJKJYJLJTIHJPTSFRAH'
// const decodedSyncUR = URDecoder.decode(syncUR);
// console.log(decodedSyncUR);
// const decoded = CryptoMultiAccounts.fromCBOR(decodedSyncUR.cbor)
// const key = decoded.getKeys()[0].getKey()
...
// // signingMessage
// const signMsgUR = "ur:sol-sign-request/otadtpdagdytwtclaysefgfyhprhmneheoeyemjoksaogtfdihjzjzjldwcxktjljpjzieclaxtaaddyoeadlocsdwykcfadykykaeykaeykaocykscnayaasofnoehs"
...
console.log(solSignRequestDecoded.toDataItem());
// generate signature
...
const solsignRequestSignature = new SolSignature(signRequestSig, solSignRequestDecoded.getRequestId());
...
// const signatureUR = "UR:SOL-SIGNATURE/OEADTPDAGDPMCMEMFSLGCKFWLBLRSBDYGHJLJPCNDIAOHDFZHEDLRLWYLKBALSYANNAAVDLBEMWNEESWMTCTEMSOHDUEPYCSKNYAZTFNCSJZHEFZADNNGRNYDPCHGWDYYALTKGJTAHMYBYDRLAWNECDMGRDKFYWFEMVYBSVOMNUYKBADBSKTVEJN"

// const decodedSigUR = URDecoder.decode(signatureUR)
// const decodedCBOR = SolSignature.fromCBOR(decodedSigUR.cbor)
// console.log(decodedCBOR.getSignature().toString('hex'));
